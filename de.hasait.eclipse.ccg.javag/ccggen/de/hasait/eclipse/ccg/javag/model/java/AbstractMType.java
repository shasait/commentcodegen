...
public abstract class AbstractMType extends AbstractMTypeContainer {
	...
	private final java.util.List _abstractMethod = new java.util.ArrayList();

	private final java.util.List _staticField = new java.util.ArrayList();
   ...
   public void write(final ContentBuffer pContent) {
	...
	/**
	 * @return An {@link java.util.Iterator} over all values of property abstractMethod.
	 * @see java.util.List#iterator()
	 */
	public final java.util.Iterator abstractMethodIterator() {
	...
	/**
	 * @return An {@link java.util.Iterator} over all values of property staticField.
	 * @see java.util.List#iterator()
	 */
	public final java.util.Iterator staticFieldIterator() {
