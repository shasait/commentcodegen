...
public abstract class AbstractMTypeContainer {
	...
	private final java.util.List _type = new java.util.ArrayList();
	...
	/**
	 * @return An {@link java.util.Iterator} over all values of property type.
	 * @see java.util.List#iterator()
	 */
	public final java.util.Iterator typeIterator() {
	...
	/**
	 * Add the specified value to property type. Referred from
	 * {@link de.hasait.eclipse.ccg.javag.model.java.AbstractMType#PROPERTY_CONTAINER_NAME}, which will be updated by
	 * this method.
	 * 
	 * @param pType
	 *           The additional value for property type.
