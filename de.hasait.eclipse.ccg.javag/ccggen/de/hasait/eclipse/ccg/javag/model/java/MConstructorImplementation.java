...
public class MConstructorImplementation {
	...
	private final java.util.List _parameterFinal = new java.util.ArrayList();

	private final java.util.List _parameterType = new java.util.ArrayList();

	private final java.util.List _parameterName = new java.util.ArrayList();

	private final MCodeBuffer _code = new MCodeBuffer();
	...
	/**
	 * @return An {@link java.util.Iterator} over all values of property parameterFinal.
	 * @see java.util.List#iterator()
	 */
	public final java.util.Iterator parameterFinalIterator() {
	...
	/**
	 * @return An {@link java.util.Iterator} over all values of property parameterName.
	 * @see java.util.List#iterator()
	 */
	public final java.util.Iterator parameterNameIterator() {
