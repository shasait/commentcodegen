/*
 * $Id: AbstractAddNatureAction.java,v 1.1 2008-04-08 11:06:15 concentus Exp $
 * 
...
public abstract class AbstractAddNatureAction implements IObjectActionDelegate {
	...
	protected AbstractAddNatureAction(final String natureId) {
		super();
		_natureId = natureId;
	}
	...
	public final void run(final IAction action) {
		if (_selection instanceof IStructuredSelection) {
			...
			if (project != null) {
				try {
					NatureUtil.addNature(project, _natureId);
