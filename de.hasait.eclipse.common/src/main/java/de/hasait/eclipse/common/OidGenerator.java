/*
 * $Id: OidGenerator.java,v 1.2 2008-06-09 11:32:37 concentus Exp $
 * 
...
public final class OidGenerator {
	...
	/**
	 * A set of recently generated OID, used to assure that no duplicates are returned to client.
	 */
	 ...
	 * 
	 * @param pInt
	 *           integer to convert to hex format
	 * @param pLength
	 *           length of string desired (hex value padded with 0's as needed)
