/*
 * $Id: AddCrNatureAction.java,v 1.1 2006-12-30 16:50:59 concentus Exp $
 * 
 ...
 */
public class AddCrNatureAction implements IObjectActionDelegate {
    ...
    public void run(IAction action) {
        if (_selection instanceof IStructuredSelection) {
            ...
            if (project != null) {
                try {
                    NatureUtil.addNature(project, CrNature.NATURE_ID);
